...
import com.proximusinspired.billing.service.BillingServiceException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({BillingServiceException.class, OrderNotAccessibleException.class})
    public ResponseEntity<Map<String, Object>> handleBusiness(RuntimeException ex, WebRequest request) {
